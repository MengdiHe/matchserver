...
class Client(Iface):
    ...
    def notify(self, opt, data):
        ...
        """
        self.send_notify(opt, data)
        return self.recv_notify()

    def send_notify(self, opt, data):
...
class Processor(Iface, TProcessor):
    ...
    def process_notify(self, seqid, iprot, oprot):
        ...
        result = notify_result()
        try:
            result.success = self._handler.notify(args.opt, args.data)
...
class notify_args(object):
    ...
    def __init__(self, opt=None, data=None,):
        self.opt = opt
        self.data = data
    ...
    def write(self, oprot):
        ...
        if self.opt is not None:
            oprot.writeFieldBegin('opt', TType.I32, 1)
            oprot.writeI32(self.opt)
            oprot.writeFieldEnd()
